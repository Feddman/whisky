<x-layouts::app :title="__('Dashboard')">
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div class="relative overflow-hidden rounded-xl border border-neutral-200 bg-white  p-4 shadow-sm">
                    <div class="flex items-start justify-between gap-3">
                        <div class="flex-1">
                            ...
                            <h3 class="mt-1 font-semibold text-lg text-zinc-900">{{ $session->name ?: __('Untitled session') }}</h3>
                            <div class="mt-2 text-xs text-zinc-500">{{ __('Code') }}: <span class="font-medium text-zinc-700 ">{{ $session->code }}</span></div>
            ...
            @empty
                <div class="col-span-full rounded-xl border border-neutral-200 bg-white p-6 text-center">
